        ...
        if event == sg.WIN_CLOSED or event == 'sair':
            ...
            with open('./rankings/publico.bin', 'rb') as publico_file:
                ...
                for publico in publicos:
                    ...
                    print(f'Capacidade do Estádio: {partida["publico_max"]}')
                    ocupacao = (partida["publico"]/partida["publico_max"])*100
                    ocupacao = round(ocupacao, 2)

                    if ocupacao > 100:
                        print(f'(partida feita em outro estádio)')

                    print(f'Ocupação do Estádio: {ocupacao}%')
