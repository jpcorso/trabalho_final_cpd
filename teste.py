...
print("------Gols do " + fun.getPartida(mais_gols["id"])["time_man"] + ": " + str(maior_goleada["gols_man"]))
print("------Gols do "+ fun.getPartida(mais_gols["id"])["time_vis"] + ": " + str(maior_goleada["gols_vis"]))
